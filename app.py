...
# Ultimate EU Test Book 2025 (5 Fragen)
{"id":"ult-1","source":"Ultimate EU Test Book","text":"DHA- und EPA-Fettsäuren finden sich in Meeresquellen wie Lachs, Thunfisch, Makrele, Sardinen und Hering. 'Andere Meeresfrüchte enthalten Omega-3-Fettsäuren, aber in viel geringeren Mengen', sagt Ernährungsberaterin Jill Weisenberger. Sowohl Land- als auch Wasser-Omega-3 sind wichtig, aber Uma Naidoo, Ärztin und Leiterin der Abteilung für Ernährungs- und Lebensstilpsychiatrie am Massachusetts General Hospital, sagt, die meeresbasierten Fettsäuren seien wichtiger. Und sie sagt, Vegetarier oder Menschen, die keinen Fisch mögen, müssen sich keine Sorgen machen, da man diese Omega-3 auch über algenbasierte Nahrungsergänzungsmittel oder Fischöl erhalten kann. Die American Heart Association (AHA) empfiehlt zwei Portionen Fisch pro Woche, bezeichnet aber in einem Bericht die Omega-3-Zufuhr der Amerikaner als 'erbärmlich niedrig'. (nationalgeographic.com)","question_type":"correct","options":[{"letter":"A","statement":"Alle Meeresfrüchte enthalten Omega-3-Fettsäuren."},{"letter":"B","statement":"Kein Amerikaner nimmt ausreichende Mengen an Omega-3 zu sich."},{"letter":"C","statement":"Omega-3-Fettsäuren können aus Meeresfrüchten und fischbasierten Ölen gewonnen werden."},{"letter":"D","statement":"EPA und DHA sind gut für die Ernährung, aber nicht essentiell."}],"correct":"C","explanation":"C ist TRUE: Der Text erwähnt Lachs, Thunfisch etc. als Quellen und Fischöl als Alternative. A ist CANNOT SAY: Der Text sagt 'andere Meeresfrüchte enthalten Omega-3 in geringeren Mengen', impliziert aber nicht dass ALLE Meeresfrüchte sie enthalten (GENERALISIERUNG). B ist FALSE: 'Erbärmlich niedrig' bezieht sich auf Amerikaner allgemein, nicht jeden einzelnen – und 'kein Amerikaner' ist eine absolute Aussage die nicht belegt ist (GENERALISIERUNG). D ist FALSE: Der Text nennt sie 'vital' (wichtig), was essentiell bedeutet (NICHT_IM_TEXT).","trap_type":"NICHT_IM_TEXT"},
{"id":"ult-2","source":"Ultimate EU Test Book","text":"Einige Forscher beginnen zu untersuchen, wie Menschen Gefühle der Einsamkeit bewältigen können. Eine im letzten Jahr in Leisure Sciences veröffentlichte Studie untersuchte zwei besonders gefährdete Gruppen – internationale Studierende und Bewohner von Pflegeheimen während der COVID-19-Pandemie – und stellte fest, dass Aktivitäten, die Konzentration und Engagement erfordern, Einsamkeitsgefühle reduzieren, selbst bei Isolation. 'Einsamkeit ist nicht so stark, wenn wir uns auf bedeutungsvolle Aktivitäten einlassen, die uns die Möglichkeit geben, authentisch zu sein', sagte John Dattilo, Professor an der Penn State University und Mitautor der Studie. Die Forscher fanden heraus, dass wenn Menschen in eine Aktivität vertieft sind, die sie herausfordert und zur Kompetenzentwicklung führt, die Zeit schneller vergeht und die Einsamkeit nachlässt. (webmd.com)","question_type":"correct","options":[{"letter":"A","statement":"Bedeutungsvolle Aktivitäten können Einsamkeitsgefühle reduzieren."},{"letter":"B","statement":"Mehr als die Hälfte der internationalen Studierenden leidet unter Einsamkeit oder Angstzuständen."},{"letter":"C","statement":"Kompetenzentwicklung ist der beste Weg, um Einsamkeit zu bekämpfen."},{"letter":"D","statement":"Bedeutungsvolle Aktivitäten beseitigen die Einsamkeit vollständig."}],"correct":"A","explanation":"A ist TRUE: Der Text sagt explizit, dass solche Aktivitäten 'Einsamkeitsgefühle reduzieren'. B ist CANNOT SAY: Internationale Studierende werden als 'gefährdete Gruppe' erwähnt, aber keine konkrete Prozentzahl genannt (NICHT_IM_TEXT). C ist CANNOT SAY: Kompetenzentwicklung wird als Aspekt erwähnt, aber nicht als 'der beste Weg' – dies ist eine Übertreibung (GEWICHTUNG). D ist FALSE: Der Text sagt 'Einsamkeit lässt nach', nicht 'wird vollständig beseitigt' – 'eradicate' ist zu stark (GENERALISIERUNG).","trap_type":"NICHT_IM_TEXT"},
{"id":"ult-3","source":"Ultimate EU Test Book","text":"An diesem Sonntag, dem 1. Oktober, tritt der CO2-Grenzausgleichsmechanismus (CBAM) in seine Übergangsphase. CBAM ist das bedeutende Instrument der EU zur Bekämpfung von Carbon Leakage und eine der zentralen Säulen der ehrgeizigen Fit-for-55-Agenda. Es gleicht den Kohlenstoffpreis zwischen einheimischen Produkten und Importen an. Dies soll sicherstellen, dass die Klimapolitik der EU nicht durch Produktionsverlagerung in Länder mit weniger ambitionierten grünen Standards oder durch den Ersatz von EU-Produkten durch kohlenstoffintensivere Importe untergraben wird. CBAM ist eine WTO-konforme Maßnahme, die die globale Industrie zu grüneren Technologien ermutigt. In seiner Übergangsphase gilt CBAM nur für Importe von Zement, Eisen und Stahl, Aluminium, Düngemitteln, Strom und Wasserstoff. EU-Importeure müssen über Importmengen und Treibhausgasemissionen berichten, aber zahlen in dieser Phase noch keinen finanziellen Ausgleich. (ec.europa.eu)","question_type":"correct","options":[{"letter":"A","statement":"Der CO2-Grenzausgleichsmechanismus soll verhindern, dass kohlenstoffintensive Produktion außerhalb der EU die Klimapolitik der EU untergräbt."},{"letter":"B","statement":"CBAM gilt zunächst nur für bestimmte Metall- und Energieproduktion."},{"letter":"C","statement":"CBAM ist speziell dafür konzipiert, die Menge des in der Europäischen Union produzierten Kohlenstoffs zu reduzieren."},{"letter":"D","statement":"Alle EU-Unternehmen müssen Informationen zum CO2-Grenzausgleichsmechanismus melden."}],"correct":"A","explanation":"A ist TRUE: Der Text sagt explizit, dass CBAM sicherstellen soll, dass 'Klimapolitik nicht durch Produktionsverlagerung untergraben wird' – genau das beschreibt Option A. B ist FALSE: CBAM umfasst auch Zement und Düngemittel, nicht nur Metalle/Energie (QUANTITAET). C ist FALSE: CBAM zielt auf Importe ab, nicht direkt auf EU-Produktion (KAUSALITAET). D ist FALSE: Nur EU-IMPORTEURE der spezifischen Güter müssen melden, nicht alle EU-Unternehmen (GENERALISIERUNG).","trap_type":"KAUSALITAET"},
{"id":"ult-4","source":"Ultimate EU Test Book","text":"Die Zahl der offenen Stellen in den USA stieg im August und wirft Fragen auf, ob sich der Arbeitsmarkt schnell genug abkühlt, um die Federal Reserve zufriedenzustellen, während die Zentralbank weitere Zinserhöhungen zur Bekämpfung der Inflation erwägt. Der am Dienstag veröffentlichte JOLTS-Bericht (Job Opening and Labor Turnover Survey) zeigte, dass Ende August 9,6 Millionen Stellen offen waren – ein Anstieg gegenüber 8,92 Millionen im Juli. Von Bloomberg befragte Ökonomen hatten mit 8,82 Millionen offenen Stellen im Juli gerechnet. Der Bericht zeigte auch einen Rückgang der Kündigungsrate, die von Ökonomen genau beobachtet wird, da erhöhte Kündigungen als Zeichen von Vertrauen unter Arbeitnehmern gelten. Im August lag die Kündigungsrate unverändert bei 2,3 Prozent – dem niedrigsten Wert seit Januar 2021. Der JOLTS-Bericht zeigte 5,9 Millionen Einstellungen im Monat, ein leichter Anstieg gegenüber 5,8 Millionen im Vormonat. (finance.yahoo.com)","question_type":"correct","options":[{"letter":"A","statement":"Die Federal Reserve erwägt Zinssenkungen, um mehr Arbeitsplätze zu schaffen."},{"letter":"B","statement":"Ende August überstieg die Zahl offener Stellen die Zahl der Arbeitslosen."},{"letter":"C","statement":"Es gab einen Rückgang der Zahl der Kündigungen in den letzten sechs Monaten."},{"letter":"D","statement":"Die Zahl der Einstellungen in den USA stieg von einem Monat zum anderen um 100.000."}],"correct":"D","explanation":"D ist TRUE: 5,9 Mio minus 5,8 Mio = 0,1 Mio = 100.000 (QUANTITAET korrekt abgeleitet). A ist FALSE: Die Fed erwägt ZINSERHÖHUNGEN, nicht Senkungen (CHRONOLOGIE/KAUSALITAET). B ist CANNOT SAY: Die Zahl der Arbeitslosen wird nicht erwähnt (NICHT_IM_TEXT). C ist CANNOT SAY: Der Text spricht nur von August-Daten und erwähnt 'niedrigster Wert seit Januar 2021', aber macht keine Aussage über den Verlauf der letzten 6 Monate (CHRONOLOGIE).","trap_type":"QUANTITAET"},
{"id":"ult-5","source":"Ultimate EU Test Book","text":"Viele Wanderer betrachten den Herbst als milde, harmlose Zeit jenseits der sommerlichen Hitze und des winterlichen Frosts. Sie unterschätzen oft die Risiken, in der Übergangszeit in Wälder, Berge und Wüsten aufzubrechen, und versäumen es, angemessene Ausrüstung mitzuführen. Such- und Rettungsbeamte warnen, dass Gefahren Lawinen, Blitzschlag, Schneestürme, Waldbrände, Wildtiere und sogar Hitze umfassen können. Wildnis-Experten äußerten ihre Bedenken nach einer neuen Studie, die zeigte, dass die meisten US-Nationalparks Temperaturen erreichen oder übersteigen, die historische Rekordmarken darstellen, zusammen mit mehr Fällen hitzebedingter Erkrankungen. Diese Forschung des National Park Service konzentriert sich auf den Grand Canyon, der mehr Such- und Rettungseinsätze hat als jeder andere US-Nationalpark. Sie zeigt, dass der Klimawandel die Zahl der Hitzschläge im Grand Canyon erhöhen könnte, insbesondere in der Übergangszeit. (nationalgeographic.com)","question_type":"correct","options":[{"letter":"A","statement":"Der Grand Canyon verzeichnet die meisten Such- und Rettungseinsätze unter den US-Nationalparks."},{"letter":"B","statement":"Herbstwanderungen sind genauso gefährlich wie Sommer- oder Winterwanderungen."},{"letter":"C","statement":"Der Klimawandel hat bereits zu mehr Hitzschlägen im Grand Canyon geführt."},{"letter":"D","statement":"Die meisten hitzebedingten Erkrankungen in US-Nationalparks treten im Sommer auf."}],"correct":"A","explanation":"A ist TRUE: Der Text sagt explizit, der Grand Canyon habe 'mehr Such- und Rettungseinsätze als jeder andere US-Nationalpark'. B ist CANNOT SAY: Der Text sagt, Wanderer UNTERSCHÄTZEN Herbstrisiken, aber macht keinen Gleichheits-Vergleich zu Sommer/Winter (GEWICHTUNG). C ist FALSE: Der Text sagt 'könnte erhöhen' (zukünftig/konditional), nicht 'hat bereits geführt' (KAUSALITAET/ZEITBEZUG). D ist CANNOT SAY: Der Text erwähnt keine saisonale Verteilung hitzebedingter Erkrankungen (NICHT_IM_TEXT).","trap_type":"CHRONOLOGIE"},
]
...
DEIN TESTDESIGN-PRINZIP (aus "The Ultimate EU Test Book" 2025):
Die schwierigsten EPSO-Fragen folgen diesem Muster: 1 richtige Aussage + 3 "Cannot say"-Aussagen. Kandidaten fühlen oft, dass ALLE VIER Optionen korrekt sind — aber 3 davon sind "unzureichend belegt" basierend auf dem Text allein.

DIE DREI AUSSAGE-TYPEN (prüfe jede Option auf Typ):
1. TRUE (richtig): Wird durch den Text eindeutig gestützt — muss durch eine logische Ableitung aus mindestens 2 Textstellen belegbar sein
2. FALSE (falsch): Widerspricht dem Text direkt oder in einem Detail
3. CANNOT SAY (unzureichend belegt): Klingt plausibel, aber der Text liefert nicht genug Information — DIES IST DIE GEFÄHRLICHSTE FALLE

TYPISCHE CANNOT-SAY-MUSTER (nutze diese für Distraktoren):
- Statistische Ableitungen ohne Basis: Text sagt "jeder Fünfte" → Option sagt "40 Millionen" (ohne dass Bevölkerungszahl im Text steht)
- Implizite Kausalität: Text beschreibt Korrelation → Option macht daraus Ursache-Wirkung
- Außenwissen als Falle: Eine Aussage die "allgemein bekannt" ist, aber nicht im Text steht
- Annahmen über Spezifika: Text sagt "körperliche Bewegung hilft" → Option sagt "Radfahren 30 Minuten täglich hilft" (Radfahren nicht erwähnt)
- Zeitliche Behauptungen ohne Beleg: Text nennt keine Dauer → Option sagt "seit 10 Jahren"

DIE 6 NICHT-ÜBEREINSTIMMUNGSTYPEN FÜR FALSE-AUSSAGEN:
- CHRONOLOGIE: Zeitliche Reihenfolge verdreht
- KAUSALITAET: Falsche Ursache-Wirkung
- QUANTITAET: Zahlen/Mengen verändert
- NICHT_IM_TEXT: Cannot say — plausibel aber nicht belegt (AM HÄUFIGSTEN bei EPSO!)
- GEWICHTUNG: "hauptsächlich/nur/vor allem" wo Text gleichwertig
- GENERALISIERUNG: "Einige" zu "Alle", "häufig" zu "immer", "kann" zu "wird"
...
2. Mindestens 1 Distraktor MUSS eine "Cannot say"-Aussage sein (außer bei Schwierigkeit "leicht").
3. Die richtige Antwort muss LOGISCH ABLEITBAR sein — nicht wörtlich kopiert.
4. Die Erklärung muss für JEDE Option klassifizieren: TRUE / FALSE / CANNOT SAY und begründen warum.
...
- Baue bewusst Formulierungen ein die Kandidaten zum Stolpern bringen: Einschränkungen ("zwar...aber", "mit Ausnahme von", "sofern nicht"), Relativierungen ("könnte", "scheint", "deutet darauf hin"), präzise Quantifizierer ("ein Drittel", "mehr als", "bis zu")
- Der Text muss in sich geschlossen und ohne Vorwissen verständlich sein
- Quellenangabe am Ende in Klammern (z.B. "(bbc.com)", "(ec.europa.eu)", "(nature.com)")
...
- Bei Schwierigkeit "schwer": Alle 3 Distraktoren sollten "Cannot say"-Aussagen sein
...
- Das Feld "correct" im JSON und die Erklärung MÜSSEN übereinstimmen.
...
{{"text":"...","question_type":"correct","options":[{{"letter":"A","statement":"..."}},{{"letter":"B","statement":"..."}},{{"letter":"C","statement":"..."}},{{"letter":"D","statement":"..."}}],"correct":"{example_correct}","explanation":"Für jede Option: TRUE/FALSE/CANNOT SAY + Begründung + Nicht-Übereinstimmungstyp","trap_type":"{trap}"}}
...
KRITISCH: Das Feld "correct" im JSON und die Erklärung MÜSSEN übereinstimmen. Wenn "correct":"{example_correct}", dann MUSS die Erklärung Option {example_correct} als TRUE und alle anderen als FALSE oder CANNOT SAY beschreiben."""
...
# ══════════════════════════════════════════════════
def show_home():
    st.markdown("""<div class="hero"><h1>Sprachlogisches Denken</h1><p class="sub">EPSO AD5 Auswahlverfahren &middot; Verbal Reasoning &middot; Deutsch</p><div class="chips"><span class="chip">37 verifizierte Fragen</span><span class="chip">KI-generierte Fragen</span><span class="chip">1:45 pro Frage</span><span class="chip">6 Fehlertypen</span></div></div>""", unsafe_allow_html=True)
